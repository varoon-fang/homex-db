...
$thumbScroller_container=$(".thumbScroller .container-img");
...
$(window).load(function() {
	...
	$(window).resize(function() {
		...
		$thumbScroller_container.stop().animate({left: sliderLeft}, 0,"easeOutCirc");
...
function FullScreenBackground(theItem,imageWidth,imageHeight){
	...
	if($toolbar.data("imageViewMode")!="original"){ //scale
		...
		$(theItem).css("margin-lefts",(winWidth-$(theItem).width())/2);
		$(theItem).css("margin-tops",(winHeight-$(theItem).height())/2);
	} else { //no scale
		$(theItem).attr("width",imageWidth);
		$(theItem).attr("height",imageHeight);
		$(theItem).css("margin-lefts",(winWidth-imageWidth)/2);
		$(theItem).css("margin-tops",(winHeight-imageHeight)/2);
	}
}
