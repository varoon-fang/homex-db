					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<?= form_open('admin/product/add_subcategory', array('class' => 'form-horizontal validation-form'));?>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span4 m-wrap" name="category">
												...
												?>
												<option value="<?= $row['product_group_id'];?>"><?= $row['product_group_name'];?></option>
												<? } ?>
									...
									<div class="control-group ">
										...
										<div class="controls">
											<div class="input-icon">
												<input class="m-wrap placeholder-no-fix span4" type="text" name="title"/>
											</div>
										</div>
									</div>
